...
namespace KnobDemo
{
    ...
    {
        public nfloat RotationAngleRadian
        {
            get;
            set;
        }

        public nfloat RotationAngleDegree
        {
            get;
            set;
        }
        ...
        public ArtboardKnobDrawing()
        {
            ...
            RotationAngleRadian = 0.0f * ((nfloat)Math.PI) / 180.0f;
            RotationAngleDegree = 0.0f;
        }
        ...
        private void DrawShapeObjectMainHandle(CGContext context)
        {
            ...
            context.RotateCTM(0.383972435438778f + RotationAngleRadian);
        ...
        private void DrawShapeObjectHandle2(CGContext context)
        {
            ...
            context.SaveState();
            CGPoint p = RotatePoint(0, 0, RotationAngleRadian, new CGPoint(78.0f - 77, 26.0f - 77));
            //context.TranslateCTM(78.000000f, 26.000000f);
            context.TranslateCTM(p.X + 77, p.Y + 77);
        ...
        public UIImage GenerateArtboardKnobDrawingBitmap()
        {
            ...
            DrawArtboardKnobDrawing(new CGRect(new CGPoint(0, 0), new CGSize(artboardKnobDrawingWidth, artboardKnobDrawingHeight)), artboardKnobDrawingFillMode);
